...
'''Building off the Node class from Problem 9,
 now we will link the nodes together.

To link the nodes, we can set a node's next attribute 
to hold another node. Update node_one from the Problem 9 to 
point to node_two.
